...
public class Response<T> {
    ...
    public static void responseJson(ServletResponse response, ResponseEnum responseEnum) throws IOException {
        ...
        writer.write(JSON.toJSONString(fail(responseEnum)));
        writer.close();
    }
    ...
    public static String toFailJson(int code, String msg) {
        return JSON.toJSONString(fail(code, msg));
    }

    public static String toFailJson(String msg) {
        return toFailJson(500, msg);
    }
}